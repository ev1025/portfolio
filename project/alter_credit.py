...
##### 기여내용
- 프로젝트 기획 및 모델링
- 사전 지식이 부족한 팀원들에게 데이터 분석 프로세스를 설명하여 협업 효과 증대
...
##### 6) 결론
- 서울 시민생활 데이터를 이용한 신용카드 연체 여부 예측은 한계가 있었다.
- 하지만, 대안 데이터를 검증할 수 있는 방안을 모색하며 그 기틀을 마련했다는 점에서 의미가 있다고 생각한다.
